/*
  # Fix create_admin_user function to not use password_hash
  
  Since we use Supabase Auth for authentication, admin_users table 
...
BEGIN
  -- Insert admin user (no password stored, handled by Supabase Auth)
