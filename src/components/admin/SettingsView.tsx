...
type SettingsTab = 'profile' | 'general' | 'appearance' | 'welcome' | 'payment' | 'email' | 'sms' | 'templates' | 'subscription' | 'domains';
...
export default function SettingsView() {
  ...
  const tabs = [
    ...
    { id: 'welcome' as SettingsTab, name: 'Welcome Features', icon: Sparkles },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-stone-200 p-6">
        ...
        {activeTab === 'welcome' && <WelcomeFeaturesSettings />}
