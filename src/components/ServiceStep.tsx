...
export default function ServiceStep({ onNext, onBack }: ServiceStepProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className={`flex-shrink-0 space-y-4 pt-4 mt-auto transform transition-all duration-500 delay-200 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}
        style={{ 
          borderTopWidth: 1,
